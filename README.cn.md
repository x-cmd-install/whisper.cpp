...
- **Star**: 53,638 · **Fork**: 6,145 · **开放 issue**: 1,978 · **贡献者**: 1,030

## 累计统计

- **发布数**: 43 · **已合并 PR**: 1059 · **开放 PR**: 179 · **已关闭 issue**: 1807 · **开放 issue**: 171 · **提交数**: 5132
...
在 [repology.org](https://repology.org/project/whisper.cpp) 上共有 **68** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**54** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T06:26:02Z._
