...
合计: **495,378** 行代码（覆盖前 5 种语言、共 **879** 个文件）。
...
- **Star**: 53,675 · **Fork**: 6,151 · **开放 issue**: 1,978 · **贡献者**: 1,046

## 累计统计

- **发布数**: 43 · **已合并 PR**: 1061 · **开放 PR**: 179 · **已关闭 issue**: 1807 · **开放 issue**: 171 · **提交数**: 5206
...
_数据快照: `data/card/260915.yml` · 2026-09-15T06:44:21Z._
